          ...
          <div class="container-fluid px-5">
            ...
            <div class="card shadow mb-4">
              <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary">Total department : <?php echo ($totDepartment != FALSE)?(count($totDepartment)):('0') ?> terdaftar</h6>
                <div class="dropdown no-arrow">
                  <a class="btn btn-sm btn-dark" href=<?php echo current_url()."/tambah" ?>>
                    <i class="fas fa-plus fa-sm fa-fw"></i> Tambah Department
                  </a>
                </div>
              </div>
              <div class="card-body">
