<?php
$content = array('user' => (object)array('isObject' => 1));
$content['user']->avatar        = 'avatar-1.png';
$content['user']->fullname      = 'Dio Ilham Djatiadi';
$content['user']->username      = 'dioilham17';
$content['user']->email         = 'dio@ringkes.in';
$content['user']->phone_number  = '087712122000';
$content['user']->gender        = 'M';
$content['user']->privilege     = 'Founder & CEO';
$content['user']->is_active     = '1';
$content['user']->created_at[0] = unix_to_human(now());
 ?>
<!-- =================================== start: content =================================== -->
              ...
              <div class="col-lg-10">
                ...
                <div class="card shadow mb-4">
                  ...
                  <div class="card-body">
                    ...
                    <hr>
                    <div class="row justify-content-center">
                      <a href=<?php echo "#" ?> class="btn btn-info col-6 mx-1">Edit profile</a>
                    </div>
                  </div>
                </div>
